...
2. **Configure MongoDB** (use MongoDB Atlas for cloud database)
3. **Build the frontend**:
   ```bash
   cd frontend
   npm run build
   ```
4. **Deploy backend** with the built frontend (Express serves static files in production)
...
- All Cloudinary, SMTP, and Arcjet credentials
